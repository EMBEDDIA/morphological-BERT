...
def main():
    def bert_cross_validation_iteration(cross_validation_part, partial_train_data_usage):
        ...
        if os.path.exists(args.output_dir + '_cv_%d' % cross_validation_part) and os.listdir(args.output_dir + '_cv_%d' % cross_validation_part) and args.do_train:
            raise ValueError("Output directory ({}) already exists and is not empty.".format(args.output_dir + '_cv_%d' % cross_validation_part))
        if not os.path.exists(args.output_dir + '_cv_%d' % cross_validation_part):
            os.makedirs(args.output_dir + '_cv_%d' % cross_validation_part)
